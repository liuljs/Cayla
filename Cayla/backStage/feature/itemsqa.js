...
let ansTime, answer;
let qas = $('.qas');
let pdtSearchs = $('.pdtSearchs'), btnSearch = $('.btnSearch');
CONNECT = 'ProductAdmin/GetProductsQnA';
// 接收資料，做渲染、處理
function process(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        ansTime = "";
        if (data[i].updated_at !== "" && data[i].updated_at !== null) {
            ansTime = `
                <div>
                    <span class="mr-1">${data[i].updated_at.split(' ')[0]} </span>
                    <span>${data[i].updated_at.split(' ')[1]} </span>
                            ...
                            <table>
                                <tbody>
                                    <tr data-num="${data[i].id}">
                                        <td data-title="產品編號">${data[i].spu_id}</td>
                                        <td class="memberAcc" data-title="會員帳號">${data[i].account}</td>
                                        <td class="item-qaContent">
                                            <div class="d-flex align-items-center justify-content-between">
                                                <label class="col-form-label py-0">留言狀態</label>
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input inputStatus edit_status" id="qaStatus" value="${data[i].Is_View}" disabled>
                                            ...
                                            <div>
                                                <div class="d-flex align-items-center justify-content-between mb-1">
                                                    <div>發問時間：</div>
                                                    <div>
                                                        <span class="mr-1">${data[i].created_at.split(' ')[0]}</span>
                                                        <span>${data[i].created_at.split(' ')[1]}</span>
                                                        <span class="text-secondary ml-2">發問</span>
                                                    </div>
                                                </div>
                                                <div class="item-question">${data[i].quection}</div>    
                                            </div>
