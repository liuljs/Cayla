                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-header d-flex align-items-center">
                                    <h2 class="text-primary mb-0">新增管理者</h2>
                                ...
                                <div class="card-body">
                                    <div class="form">
                                        ...
                                        <div class="text-right my-3">
                                            <button type="submit" class="btn btn-primary btnAddMana"><i class="far fa-user-tie"></i> 新增</button>
                                        </div> 
                                    </div>
                                </div>
                            </div>
                                ...
                                $(document).on('click', '.btnEdit', function (e) {
                                    ...
                                    if ($('td.setup').hasClass('active')) { // 如果有欄位在編輯狀態的話，其他欄位就不能用
                                        ...
                                        $('.btnSave').on('click', function (e) {
                                            ...
                                            if (check == true) {
                                                let dataObj = {
                                                    "account_id": trz.find('.managerName').data('id'),
                                        ...
                                        trz.find('.btnThirds').append(`
                                            <a href="#" class="text-primary btnThird btnOpenPsw" data-toggle="modal" data-target="#manPswEdit">［密碼］</a>
                                        `);
                                        // 更新會員密碼
