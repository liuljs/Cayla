    ...
    for (let i = 0; i < data.length; i++) {
        html += `
            <tr data-num="${data[i].Id}">
                ...
                <td data-title="圖片"><div class="bannerImgs"><img src="${data[i].Image_Url}"></div></td>
                <td data-title="連結">
                    <input type="text" class="form-control inputStatus edit_link" value="${data[i].Image_Link}" disabled>
                </td>
                <td data-title="順序">
                    <div class="form-check">
                        <label class="form-check-label mr-0">
                            <input type="checkbox" class="form-check-input inputStatus edit_sort" value="${data[i].First}" disabled>
